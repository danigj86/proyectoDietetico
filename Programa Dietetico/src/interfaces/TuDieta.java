...
public class TuDieta extends JPanel{
	...
	public TuDieta(Ventana v) {
		...
		JLabel desayunoAqui = new JLabel("desayuno aqui"); //ventana.getDietaUsuario().getPlato()[0].getPlato(0)
		...
		JLabel almuerzoAqui = new JLabel(ventana.getUsuario().getNombre());
		...
		JLabel meriendaAqui = new JLabel("meriedna aqui");
		...
		JLabel cenaAqui = new JLabel("AQUI LA CENA");
